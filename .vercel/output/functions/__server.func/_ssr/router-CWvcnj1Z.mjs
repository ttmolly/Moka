		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					className: "-mx-1 flex gap-1 overflow-x-auto pb-1 sm:pb-0",
					children: LINKS.map((link) => {
						const active = pathname === link.to;
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: link.to,
							className: cn("shrink-0 rounded-sm px-3 py-2 text-sm transition-colors duration-150", active ? "bg-surface text-fg" : "text-muted hover:text-fg"),
							children: link.label
						}, link.to);
					})
				})]
...
var styles_default = "/assets/styles-BkB2aOBm.css";
var APP_NAME = "Moka";
var Route$6 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Linux-native ONNX Runtime backend for Laya typed-decision models. Converted graphs, fidelity gates, live Snake."
			},
			{
				name: "theme-color",
				content: "#0e0c0b"
...
var rootRouteChildren = {
	...
	BenchmarksRoute: Route$4.update({
		id: "/benchmarks",
		path: "/benchmarks",
		getParentRoute: () => Route$6
	}),
	ConvertRoute: Route$3.update({
		id: "/convert",
		path: "/convert",
		getParentRoute: () => Route$6
	}),
	FidelityRoute: Route$2.update({
		id: "/fidelity",
		path: "/fidelity",
		getParentRoute: () => Route$6
	}),
